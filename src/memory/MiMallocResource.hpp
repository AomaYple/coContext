...
namespace coContext::internal {
    ...
    public:
        ...
        [[nodiscard]] auto do_allocate(std::size_t numberOfBytes, std::size_t alignment) -> void * override;

        auto do_deallocate(void *pointer, std::size_t numberOfBytes, std::size_t alignment) noexcept -> void override;

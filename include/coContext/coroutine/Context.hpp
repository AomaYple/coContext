...
namespace coContext {
    ...
    public:
        ...
        [[nodiscard]] auto socket(std::int32_t domain, std::int32_t type, std::int32_t protocol,
                                  std::uint32_t flags = 0) -> AsyncWaiter;
        ...
        [[nodiscard]] auto open(std::string_view pathname, std::int32_t flags, std::uint32_t mode,
                                std::int32_t directoryFileDescriptor = AT_FDCWD) -> AsyncWaiter;
